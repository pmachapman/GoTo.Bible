...
namespace GoToBible.Model
{
    ...
    /// <summary>
    /// The passage reference processor.
    /// </summary>
    public class PassageReference
    {
        ...
        /// The book.
        /// </summary>
        private readonly string book = string.Empty;
        ...
        /// </summary>
        /// <remarks>
        /// This returns an invalid passage reference.
        /// </remarks>
        ...
        /// Initialises a new instance of the <see cref="PassageReference"/> class.
        /// </summary>
        /// <param name="passage">The passage reference.</param>
        public PassageReference(string passage)
        {
            // Check input
            ...
            if (BookLengths[book] is int[] chapters)
            {
                ...
                foreach (string range in ranges)
                {
                    ...
                    this.Normalised = CultureInfo.CurrentCulture.TextInfo.ToTitleCase($"{book} {chapter}:{verse}");
                    this.book = book;
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="PassageReference" /> is valid.
        /// </summary>
        /// <value>
        ...
        /// </summary>
        /// <value>
        /// The normalised passage reference.
        /// </value>
        public string Normalised { get; private set; } = string.Empty;

        /// <summary>
        /// Gets the original passage reference.
        /// </summary>
        /// <value>
